...
public class App extends JFrame {
	...
	public void listActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_listActionPerformed
		...
		if (device.isStatus()) {
			...
			for (StringBuilder deviceInfo : devicesToChooseFrom) {
				...
				outputText.append(deviceInfo.toString());
	...
	public void selectActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_selectActionPerformed
		...
		device.setChoosenDevice(devicesToChooseFrom[k]); 
		outputText.append(device.getChoosenDevice().getDescription() + "\n");
...
private Vertx vertx ;
private StringBuilder[] devicesToChooseFrom;
